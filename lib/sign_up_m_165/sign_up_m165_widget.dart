...
class SignUpM165Widget extends StatefulWidget {
  const SignUpM165Widget({Key? key}) : super(key: key);

  @override
  _SignUpM165WidgetState createState() => _SignUpM165WidgetState();
}

class _SignUpM165WidgetState extends State<SignUpM165Widget> {
                                            ...
                                            children: [
                                              SelectionArea(
                                                ...
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'l1fhcfh1' /* Add trainings and education yo... */,
                                                ),
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: FutureBuilder<
                                      ...
                                      future: queryEducationDegreeRecordOnce(),
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText:
                                        ...
                                        '1fln6ucc' /* Education / Training Name */,
                                      ),
                                ...
                                Expanded(
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText:
                                          FFLocalizations.of(context).getText(
                                        'v5e7ci7m' /* Name of Institue / Company */,
                                      ),
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .bodyText2,
                                      enabledBorder: OutlineInputBorder(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                final educationCreateData =
                                    createEducationRecordData(
                                  educationDegree:
                                      FFAppState().chosenEducationDegree,

...
class SignupM166Widget extends StatefulWidget {
  const SignupM166Widget({Key? key}) : super(key: key);

  @override
  _SignupM166WidgetState createState() => _SignupM166WidgetState();
}
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          Padding(
                            padding:
                                EdgeInsetsDirectional.fromSTEB(15, 20, 15, 15),
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                                    ...
                                    StreamBuilder<List<EducationRecord>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        return ListView.builder(
                                          ...
                                          itemCount: listViewEducationRecordList
                                              .length,
                                          itemBuilder:
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: FutureBuilder<
                                                                ...
                                                                builder: (context,
                                                                  ...
                                                                  final textEducationDegreeRecord =
                                                                      snapshot
                                                                          .data!;
                                                                  return Text(
                                                                    textEducationDegreeRecord
                                                                        .displayName!,
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyText1,
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    FFButtonWidget(
                                      ...
                                      text: FFLocalizations.of(context).getText(
                                        'ntficze9' /* + Add  another Training or Edu... */,
                                      ),
                                      options: FFButtonOptions(
                                        width: 290,
                                        height: 40,
